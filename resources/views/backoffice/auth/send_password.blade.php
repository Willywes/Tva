...
<div class="login-boxer">
    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <form action="{{ route('backoffice.login.send-password') }}" method="POST">
                {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <a href="{{ route('backoffice.login.show-recovery-password') }}" class="text-danger">ya tengo el código</a>
                    </div>
                    <div class="col-xs-4">
