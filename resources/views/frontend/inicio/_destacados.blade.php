                        ...
                        <div class="col-10 offset-1">
                            <div class="row">
                                <div class="col-md-12 red-banner">
                                    <div class="p-2 font-18 thin text-center">
                                        <i class="fas fa-store-alt"></i> Retiro en local : <span class="semibold mr-3">20 Minutos</span>
                                        <i class="fas fa-motorcycle"></i> Entrega : <span class="semibold mr-3">45 Minutos</span>
